...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNDAwAiPCAAA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `刑事案件 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNDAwMjAwNiACAAA.shtml`,
        item: items,
    };
};
