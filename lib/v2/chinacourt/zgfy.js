...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNAAhMwMiAAA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `最高法院 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNAAhMwMiAAA.shtml`,
        item: items,
    };
};
