...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNDAwNQCRhAEA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `民事研究 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNDAwNQCRhAEA.shtml`,
        item: items,
    };
};
