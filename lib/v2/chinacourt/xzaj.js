...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNDAwMjAwNiACAAA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `行政案件 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNAAhcwMiAAA.shtml`,
        item: items,
    };
};
