...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNDAwMjAwMSACAAA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `典型案例 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNDAwMjAwMSACAAA.shtml`,
        item: items,
    };
};
