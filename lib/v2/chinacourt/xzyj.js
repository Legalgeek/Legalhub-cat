...
module.exports = async (ctx) => {
    ...
    const { data: response } = await got(`https://www.chinacourt.org/article/index/id/MzAwNDAwNTAwNiACAAA.shtml`);
    ...
    ctx.state.data = {
        ...
        title: `行政研究 · 中国法院网`,
        // 源链接
        link: `https://www.chinacourt.org/article/index/id/MzAwNDAwNTAwNiACAAA.shtml`,
        item: items,
    };
};
