...
module.exports = async (ctx) => {
    ...
    switch (gch) {
        ...
        case '81418X':
            ...
            break;
        case '82464X':
            qikan = '《法学研究》·中国社会科学院法学研究所 主办';
            break;
        case '81439X':
            qikan = '《中外法学》·北京大学 主办';
            break;
        case '81213X':
            qikan = '《政法论坛》·中国政法大学 主办';
            break;
        case '89403X':
            qikan = '《清华法学》·清华大学 主办';
            break;
        case '81949A':
            qikan = '《环球法律评论》·中国社会科学院法学研究所 主办';
            break;
        case '81698X':
            qikan = '《法学家》·中国人民大学 主办';
            break;
        case '82101X':
            qikan = '《现代法学》·西南政法大学 主办';
            break;
        case '81380A':
            qikan = '《法律科学》·西北政法大学 主办';
            break;
        case '81622X':
            qikan = '《法学评论》·武汉大学 主办';
            break;
        case '82329X':
            qikan = '《法制与社会发展》·吉林大学 主办';
            break;
        case '81666A':
            qikan = '《法商研究》·中南财经政法大学 主办';
            break;
        case '82496X':
            qikan = '《比较法研究》·中国政法大学 主办';
            break;
        case '81908X':
            qikan = '《中国社会科学》·中国社会科学院 主办';
            break;
        case '81084X':
            qikan = '《政治与法律》·上海社会科学院法学研究所 主办';
            break;
        case '70334X':
            qikan = '《东方法学》·上海市法学会、上海人民出版社 主办';
            break;
        case '82632A':
            qikan = '《华东政法大学学报》·华东政法大学 主办';
            break;
        case '81658X':
            qikan = '《法学论坛》·山东省法学会 主办';
            break;
        case '82208X':
            qikan = '《法学杂志》·北京市法学会 主办';
            break;
        case '82198X':
            qikan = '《国家检察官学院学报》·国家检察官学院 主办';
            break;
        case '82582X':
            qikan = '《行政法学研究》·中国政法大学 主办';
            break;
    }
    ...
    const items = await Promise.all(
        list.map((item) =>
            ctx.cache.tryGet(item.key, async () => {
                ...
                item.description = `摘要：${content.remark_c || '无'}<br/><br/>关键词：${content.keyword_c || '无'}<br/><br/>作者：${content.showwriter || '无'}<br/>作者单位：${content.organ || '无'}<br/>期刊：《${
                    content.media_c
                }》${content.medias_qk}<br/><br/>原文链接：<a href="${item.link}">${item.link || '无'}</a>`;
